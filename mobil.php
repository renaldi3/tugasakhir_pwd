...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Quick Drive - Katalog Mobil</title>
    ...
    <div class="container mt-5 mb-5">
                    <div class="card shadow border-dark">
                        <div class="card-header py-3 align-items-center justify-content-between">
                            <h4 class="display-5 text-center">Katalog Mobil</h4>
                        </div>
                                <div class="card-body">
                                      <!-- Kendaraan Section -->
                                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 mb-4" id="kendaraanContainer">
                                        <?php
                                        include 'koneksi.php';
                                        $query = mysqli_query($conn, "SELECT * FROM kendaraan WHERE tipe='mobil' ORDER BY nama_kendaraan ASC");
                                        if ($query->num_rows > 0) {
