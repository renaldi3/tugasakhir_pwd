...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($conn, "UPDATE petugas SET username='$username', password='$password',nama_petugas='$nama_petugas',email='$email',role='$role' WHERE id_petugas='$id'");
    ...
    <h2>Edit Data Petugas</h2>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_petugas" name="nama_petugas" value="<?php echo $data['nama_petugas']; ?>" required>
            </div>
            <div class="mb-3">
