...
<head>
    ...
    <title>Quick Drive - Data Petugas</title>
    <!-- Bootstrap CDN -->
...
<div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <tbody> 
                        ...
                        ?>
                            <tr>
                                ...
                                <td width="20%">
                                    <a href="editPetugas.php?id_petugas=<?php echo $data['id_petugas'];?>" class="btn btn-warning btn-sm">
                                        Edit
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm delete-btn" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="<?php echo $data ['id_petugas']; ?>">
                                    Hapus
                                    </button>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <a href="hapusPetugas.php?id_petugas=" id="delete-link" class="text-decoration-none text-white">Hapus</a>
            </button>
        </div>
        </div>
    </div>
...
<script>
    ...
    $('#delete-link').attr('href', 'hapusPetugas.php?id_petugas=' + id);
    });
</script>
</body>
</html>